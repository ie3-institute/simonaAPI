...
/* ci configuration */
String sonarqubeProjectKey = 'edu.ie3:simonaAPI' // sonarqube project key, case-sensitive
String codeCovTokenId = 'simonaAPI-codecov-token' // id that matches the code coverage token set as jenkins property
